/**
 * Basic program to obtain properly-scaled gyro, accelerometer, 
 * and magnetometer data from the MPU-9250 9-axis motion sensor and do 9 DoF 
 * sensor fusion using the open-source Madgwick and Mahony sensor fusion filters. 
 * Running on STM32F401RE Nucleo board at 84 MHz achieves sensor fusion filter 
 * update rates of ~5000 Hz.
 */
